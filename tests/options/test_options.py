...
class TestOptions(unittest.TestCase):
    ...
    def test_keyword_set_present2(self):
        self.assertTrue(
            keyword_set_present([["world"]], "Hello World!"),
            "Keyword present!"
        )

    def test_keyword_set_present3(self):
        self.assertTrue(
            keyword_set_present([["hello", "world"]], "Hello World!"),
            "Keyword set present!"
        )

    def test_keyword_set_present4(self):
        self.assertTrue(
            keyword_set_present([["bye"], ["world"]], "Hello World!"),
            "Keyword present!"
        )

    def test_keyword_set_present5(self):
        self.assertFalse(
            keyword_set_present([["hello", "nntin"]], "Hello World!"),
            "Keyword set not present"
        )

    def test_keyword_set_present6(self):
        self.assertTrue(
            keyword_set_present([["bye", "world"], ["hello"]], "Hello World!"),
            "Keyword present!"
        )
